...
const HotelDetail = () => {
  ...
  const daysLeft = dayDifference(traveldate[0]?.endDate, traveldate[0]?.startDate)
  const photos = [
    {
        ...
        <div className="hotelWrapper">
          ...
          <div className="hotelDetails">
            ...
            <div className="hotelDetailsPrice">
              <h1>Perfect for a {daysLeft}-night stay!</h1>
              <span>
                Located in the real heart of Krakow, this property has an
                excellent location score of 9.8!
              </span>
              <h2>
                <b>${data.hotel?.cheapestPrice * daysLeft }</b> ({daysLeft} nights)
              </h2>
